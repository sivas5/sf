...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Qry=args[0];
        	...
        	System.out.println("Usage Query.jar \"Select * from table\"");
        	return;
        }
        try {
    ...
    // Query using REST HttpGet
    public static void queryWB() {
        System.out.println("\n_______________ WB QUERY _______________");
        try {
 
            //Set up the HTTP objects needed to make the request.
            HttpClient httpClient = HttpClientBuilder.create().build();
 
            String uri = baseUri + "/query?q=" + Qry;
